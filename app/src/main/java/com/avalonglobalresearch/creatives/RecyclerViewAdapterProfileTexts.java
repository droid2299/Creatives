...
public class RecyclerViewAdapterProfileTexts extends RecyclerView.Adapter<RecyclerViewAdapterProfileTexts.ViewHolder> {
    ...
    public RecyclerViewAdapterProfileTexts(Context context, List<ImageUploadInfo> TempList) {
    ...
    public RecyclerViewAdapterProfileTexts.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewAdapterProfileTexts.ViewHolder holder, int position) {
