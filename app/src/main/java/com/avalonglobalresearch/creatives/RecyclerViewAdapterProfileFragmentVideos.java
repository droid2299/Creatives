...
public class RecyclerViewAdapterProfileFragmentVideos extends RecyclerView.Adapter<RecyclerViewAdapterProfileFragmentVideos.ViewHolder> {
    ...
    public RecyclerViewAdapterProfileFragmentVideos(Context context, List<ImageUploadInfo> TempList) {
    ...
    @Override
    public RecyclerViewAdapterProfileFragmentVideos.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewAdapterProfileFragmentVideos.ViewHolder holder, int position) {
